...
var (
	userAllColumns            = []string{"id", "username", "password", "firstname", "lastname", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"username", "password", "firstname", "lastname"}
...
func (o *User) Cart(mods ...qm.QueryMod) cartQuery {
...
func (userL) LoadCart(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
// SetCart of the user to the related item.
// Sets o.R.Cart to related.
// Adds o to related.R.User.
func (o *User) SetCart(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Cart) error {
	var err error
