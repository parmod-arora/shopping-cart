...
type Order struct {
	...
	SubTotalAmount int64     `boil:"sub_total_amount" json:"sub_total_amount" toml:"sub_total_amount" yaml:"sub_total_amount"`
...
var OrderWhere = struct {
	...
	SubTotalAmount whereHelperint64
	...
	SubTotalAmount: whereHelperint64{field: "\"orders\".\"sub_total_amount\""},
...
var (
	orderAllColumns            = []string{"id", "user_id", "reference", "total_amount", "sub_total_amount", "created_at", "updated_at"}
	orderColumnsWithoutDefault = []string{"user_id", "reference", "total_amount", "sub_total_amount"}
...
func (o *Order) OrderCoupons(mods ...qm.QueryMod) orderCouponQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"order_coupons\".\"order_id\"=?", o.ID),
	)
...
func (orderL) LoadOrderCoupons(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrder interface{}, mods queries.Applicator) error {
	var slice []*Order
	var object *Order
	...
	query := NewQuery(
		...
		qm.WhereIn(`order_coupons.order_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (orderL) LoadOrderDiscounts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrder interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`order_discount.order_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Order) AddOrderCoupons(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*OrderCoupon) error {
	var err error
