...
var ProductWhere = struct {
	...
	Details:   whereHelperstring{field: "\"products\".\"details\""},
	Amount:    whereHelperint64{field: "\"products\".\"amount\""},
	Currency:  whereHelperstring{field: "\"products\".\"currency\""},
	Image:     whereHelperstring{field: "\"products\".\"image\""},
...
var (
	productAllColumns            = []string{"id", "name", "details", "amount", "currency", "image", "created_at", "updated_at"}
	productColumnsWithoutDefault = []string{"name", "details", "amount", "currency", "image"}
...
func (o *Product) ProductDiscounts(mods ...qm.QueryMod) productDiscountQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"product_discounts\".\"product_id\"=?", o.ID),
	)
...
func (o *Product) Stocks(mods ...qm.QueryMod) stockQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"stocks\".\"product_id\"=?", o.ID),
	)
...
func (productL) LoadProductDiscounts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProduct interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`product_discounts.product_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Product) AddPackagedWithProductProductComboDiscounts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ProductComboDiscount) error {
	...
	for _, rel := range related {
		if insert {
			rel.PackagedWithProductID = o.ID
			if err = rel.Insert(ctx, exec, boil.Infer()); err != nil {
				return errors.Wrap(err, "failed to insert into foreign table")
			}
		} else {
